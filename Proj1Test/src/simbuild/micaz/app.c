...
# 9 "dataStructures/pair.h"
#line 6
typedef struct pair {
  uint8_t src;
  uint8_t seq;
} pair;
# 9 "dataStructures/dvr.h"
#line 5
typedef struct dvr {
  uint8_t dest;
  uint8_t cost;
...
# 7 "dataStructures/modules/dvrTransmission.h"
#line 4
...
# 18 "lib/interfaces/FloodSend.nc"
...
#line 9
static bool FloodSendP$FloodSend$HistoryListContains(pair toFind);
#line 25
...
# 16 "dataStructures/interfaces/HistoryList.nc"
static bool /*NodeC.HistListC*/HistoryListC$0$HistoryList$listContains(pair *toFind);
#line 6
static void /*NodeC.HistListC*/HistoryListC$0$HistoryList$pushback(pair input);
# 9 "dataStructures/interfaces/NeighborList.nc"
...
# 5 "dataStructures/interfaces/RoutingTable.nc"
...
#line 9
static bool Node$FS$HistoryListContains(pair toFind);
#line 25
...
uint8_t Node$firstTime[1000];


uint16_t Node$routingTableCurrentSize[1000];
...
static inline bool FloodSendP$FloodSend$HistoryListContains(pair toFind);
...
# 6 "dataStructures/modules/HistoryListC.nc"
...
static void /*NodeC.HistListC*/HistoryListC$0$HistoryList$pushback(pair input);
#line 97
static inline bool /*NodeC.HistListC*/HistoryListC$0$HistoryList$listContains(pair *toFind);
# 5 "dataStructures/interfaces/RoutingTable.nc"
...
# 8 "dataStructures/modules/NeighborListC.nc"
...
static inline bool /*NodeC.neighborListC*/NeighborListC$0$NeighborList$neighborsContains(uint8_t toFind);
#line 120
...
# 5 "dataStructures/modules/RoutingTableC.nc"
...
# 105 "dataStructures/modules/RoutingTableC.nc"
static inline void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$updateTable(uint8_t *payld, uint8_t source)
#line 105
{
...
# 9 "dataStructures/interfaces/RoutingTable.nc"
...
#line 9
# 186 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$updateRoutingTable(uint8_t *payld, uint8_t source)
#line 186
{
...
# 28 "dataStructures/interfaces/NeighborList.nc"
...
# 24 "lib/interfaces/FloodSend.nc"
...
#line 4
# 198 "dataStructures/modules/RoutingTableC.nc"
static inline void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$printTable(void )
#line 198
{
  uint16_t i = 0;
...
#line 200
  sim_log_debug(214U, "Project2DV", " printing routing table (dest,cost,nextHop): \n");
  for (i = 0; i < /*NodeC.RoutTableC*/RoutingTableC$0$size[sim_node()]; i++) {
      sim_log_debug_clear(215U, "Project2DV", "[ %d, %d, %d]\n", /*NodeC.RoutTableC*/RoutingTableC$0$table[sim_node()][i].dest, /*NodeC.RoutTableC*/RoutingTableC$0$table[sim_node()][i].cost, /*NodeC.RoutTableC*/RoutingTableC$0$table[sim_node()][i].nextHop);
    }

  sim_log_debug_clear(216U, "Project2DV", "\n");
}

# 11 "dataStructures/interfaces/RoutingTable.nc"
...
#line 11
# 190 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$printRoutingTable(void )
#line 190
{
...
# 29 "dataStructures/interfaces/NeighborList.nc"
...
# 23 "lib/interfaces/FloodSend.nc"
...
#line 23
# 120 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$printNeighbors(void )
#line 120
{
  uint16_t i = 0;
...
#line 122
  sim_log_debug(184U, "Project2DV", " printing neighbors: ");
  for (i = 0; i < /*NodeC.neighborListC*/NeighborListC$0$size[sim_node()]; i++) {
      sim_log_debug_clear(185U, "Project2DV", "[ %d, p %d ]", /*NodeC.neighborListC*/NeighborListC$0$container[sim_node()][i].src, /*NodeC.neighborListC*/NeighborListC$0$container[sim_node()][i].seq);
    }

  sim_log_debug_clear(186U, "Project2DV", "\n");
}

# 18 "dataStructures/interfaces/NeighborList.nc"
...
# 12 "lib/interfaces/FloodSend.nc"
...
#line 12
# 6 "dataStructures/interfaces/HistoryList.nc"
...
# 10 "lib/interfaces/FloodSend.nc"
...
#line 65
  sim_log_debug(55U, "genDebug", "CMD_ERROR: \"%s\" does not match any known commands.\n", array);
  return CMD_ERROR;
}
...
# 97 "dataStructures/modules/HistoryListC.nc"
static inline bool /*NodeC.HistListC*/HistoryListC$0$HistoryList$listContains(pair *toFind)
#line 97
{

  if (/*NodeC.HistListC*/HistoryListC$0$size[sim_node()] == 0) {
...
#line 104
      for (i; i < /*NodeC.HistListC*/HistoryListC$0$size[sim_node()]; i++) {
          if ((/*NodeC.HistListC*/HistoryListC$0$container[sim_node()][i].src == toFind->src) & (/*NodeC.HistListC*/HistoryListC$0$container[sim_node()][i].seq == toFind->seq)) {
              return TRUE;
            }
        }
      return FALSE;
...
# 16 "dataStructures/interfaces/HistoryList.nc"
inline static bool FloodSendP$histList$listContains(pair *toFind){
#line 16
  unsigned char __nesc_result;
#line 16

#line 16
  __nesc_result = /*NodeC.HistListC*/HistoryListC$0$HistoryList$listContains(toFind);
#line 16
...
#line 16
# 98 "lib/modules/FloodSendP.nc"
static inline bool FloodSendP$FloodSend$HistoryListContains(pair toFind)
#line 98
{
  return FloodSendP$histList$listContains(&toFind);
}

# 9 "lib/interfaces/FloodSend.nc"
inline static bool Node$FS$HistoryListContains(pair toFind){
#line 9
  unsigned char __nesc_result;
#line 9

#line 9
  __nesc_result = FloodSendP$FloodSend$HistoryListContains(toFind);
#line 9
...
#line 128
      if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == AM_BROADCAST_ADDR) {
          sim_log_debug(172U, "proj1N", " TTL no %d, src no %d, seq no %d, dest no %d time no %d\n", __nesc_ntoh_uint8(myMsg->TTL.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), Node$periodicTimer$getNow());
        }
      else {
          sim_log_debug(173U, "genDebug", " TTL no %d, src no %d, seq no %d, dest no %d time no %d\n", __nesc_ntoh_uint8(myMsg->TTL.nxdata), __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->seq.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), Node$periodicTimer$getNow());
        }
      Node$makePair(&Node$one[sim_node()], (uint8_t )__nesc_ntoh_uint16(myMsg->src.nxdata), (uint8_t )__nesc_ntoh_uint16(myMsg->seq.nxdata));
      if ((TOS_NODE_ID == __nesc_ntoh_uint16(myMsg->dest.nxdata)) & (!Node$FS$HistoryListContains(Node$one[sim_node()]) | (__nesc_ntoh_uint16(myMsg->dest.nxdata) == __nesc_ntoh_uint16(myMsg->src.nxdata)))) {
          sim_log_debug(174U, "genDebug", "Packet from %d has arrived! Msg: %s\n", __nesc_ntoh_uint16(myMsg->src.nxdata), myMsg->payload);
          switch (__nesc_ntoh_uint8(myMsg->protocol.nxdata)) {
              ...
              case PROTOCOL_PING: 
                if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) >= 1) {
                    sim_log_debug(175U, "genDebug", "Sending Ping Reply to %d! \n", __nesc_ntoh_uint16(myMsg->src.nxdata));
              ...
              case PROTOCOL_PINGREPLY: 
                ...
                Node$makePair(&Node$one[sim_node()], (uint8_t )__nesc_ntoh_uint16(myMsg->src.nxdata), (uint8_t )__nesc_ntoh_uint16(myMsg->seq.nxdata));
              sim_log_debug(176U, "genDebug", "Received a Ping Reply from %d!\n", __nesc_ntoh_uint16(myMsg->src.nxdata));
              Node$FS$HistoryPushBack(Node$one[sim_node()]);
              break;
  ...
  sim_log_debug(178U, "genDebug", "Unknown Packet Type \n");
  return msg;
}
...
# 78 "/home/ubuntu/local/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x408c7b08, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x408c7b08) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x408c7b08, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 53
# 105 "dataStructures/modules/NeighborListC.nc"
static inline bool /*NodeC.neighborListC*/NeighborListC$0$NeighborList$neighborsContains(uint8_t toFind)
#line 105
{
...
# 17 "dataStructures/interfaces/NeighborList.nc"
...
# 180 "dataStructures/modules/RoutingTableC.nc"
static inline void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$NeighborGotAdded(uint8_t element)
#line 180
{
}

# 10 "dataStructures/interfaces/RoutingTable.nc"
...
#line 10
# 16 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$pushback(pair input)
#line 16
{
...
# 7 "dataStructures/interfaces/NeighborList.nc"
...
#line 7
# 168 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$incrementANeighbor(uint8_t toIncr)
#line 168
{
  uint16_t j = 0;
...
# 23 "dataStructures/interfaces/NeighborList.nc"
...
#line 23
# 12 "dataStructures/interfaces/RoutingTable.nc"
...
#line 12
# 194 "dataStructures/modules/NeighborListC.nc"
static inline uint8_t /*NodeC.neighborListC*/NeighborListC$0$NeighborList$nextHopFromDest(uint8_t dest)
#line 194
{
...
# 30 "dataStructures/interfaces/NeighborList.nc"
...
#line 52
# 13 "dataStructures/interfaces/RoutingTable.nc"
...
#line 13
# 198 "dataStructures/modules/NeighborListC.nc"
static inline uint8_t /*NodeC.neighborListC*/NeighborListC$0$NeighborList$costFromDest(uint8_t dest)
#line 198
{
...
# 31 "dataStructures/interfaces/NeighborList.nc"
...
# 78 "/home/ubuntu/local/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x408c41b8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x408c41b8, msg, payload, len);
#line 78
...
#line 66
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(171U, "genDebug", "Radio On\n");
      Node$periodicTimer$startPeriodic(Node$randNum[sim_node()]);
      Node$RTtimer$startPeriodic(Node$randNum[sim_node()] + 13000);
    }
  else 
#line 114
    {
...
# 110 "/home/ubuntu/local/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x408c7148, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x408c7148, msg, error);
#line 110
}
#line 110
...
#line 81
# 80 "/home/ubuntu/local/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40d10730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40d10730, addr, msg, len);
#line 80
...
#line 94
        {
          sim_log_debug(217U, "genDebug", "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 98
    {
      sim_log_debug(218U, "genDebug", "The radio is busy");
      return EBUSY;
    }
...
# 106 "lib/modules/SimpleSendP.nc"
static inline void SimpleSendP$AMSend$sendDone(message_t *msg, error_t error)
#line 106
{
...
# 100 "/home/ubuntu/local/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40d13cb0, message_t * msg, error_t error){
#line 100
  switch (arg_0x40d13cb0) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40d13cb0, msg, error);
#line 100
      break;
#line 100
    }
...
# 15 "lib/interfaces/FloodSend.nc"
...
#line 15
# 129 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$decrementNeighborPing(void )
#line 129
{
...
# 19 "dataStructures/interfaces/NeighborList.nc"
...
# 14 "lib/interfaces/FloodSend.nc"
...
#line 14
# 48 "dataStructures/modules/NeighborListC.nc"
static inline pair /*NodeC.neighborListC*/NeighborListC$0$NeighborList$popback(void )
#line 48
{
  pair returnVal;
...
# 85 "dataStructures/modules/RoutingTableC.nc"
static inline void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$NeighborGotDeleted(uint8_t element)
#line 85
{
  uint16_t i;
...
# 8 "dataStructures/interfaces/RoutingTable.nc"
...
#line 8
# 151 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$deleteNeighbor(uint8_t toDelete)
#line 151
{
  uint16_t i = 0;
...
# 21 "dataStructures/interfaces/NeighborList.nc"
...
# 13 "lib/interfaces/FloodSend.nc"
...
#line 235
{
  ...
  Node$makePack(&Node$sendPackage[sim_node()], TOS_NODE_ID, AM_BROADCAST_ADDR, 2, 
  PROTOCOL_PING, 0, &Node$someNum[sim_node()], sizeof(uint8_t ));
  Node$FS$SimpleSendSend(Node$sendPackage[sim_node()], AM_BROADCAST_ADDR);
}

# 94 "dataStructures/modules/NeighborListC.nc"
static inline pair /*NodeC.neighborListC*/NeighborListC$0$NeighborList$get(uint16_t position)
#line 94
{
...
# 16 "dataStructures/interfaces/NeighborList.nc"
...
# 19 "lib/interfaces/FloodSend.nc"
...
#line 19
# 49 "dataStructures/modules/RoutingTableC.nc"
static inline void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$writeToPayload(uint8_t *payld, uint8_t neigbr)
#line 49
{
  uint16_t it;
...
# 7 "dataStructures/interfaces/RoutingTable.nc"
...
#line 7
# 183 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$writeToPayloadFromRoutingTable(uint8_t *payld, uint8_t neighbor)
#line 183
{
...
# 27 "dataStructures/interfaces/NeighborList.nc"
...
# 21 "lib/interfaces/FloodSend.nc"
...
#line 21
# 90 "dataStructures/modules/NeighborListC.nc"
static inline uint16_t /*NodeC.neighborListC*/NeighborListC$0$NeighborList$size(void )
#line 90
{
...
# 15 "dataStructures/interfaces/NeighborList.nc"
...
#line 18
# 13 "dataStructures/modules/RoutingTableC.nc"
static inline void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$populateTable(pair *list, uint16_t listSize)
#line 13
{
  uint16_t i;
...
#line 5
# 177 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$populateRoutingTable(void )
#line 177
{
...
# 25 "dataStructures/interfaces/NeighborList.nc"
...
# 25 "lib/interfaces/FloodSend.nc"
...
#line 62
# 55 "dataStructures/modules/NeighborListC.nc"
static inline void /*NodeC.neighborListC*/NeighborListC$0$NeighborList$clearAll(void )
#line 55
{
...
#line 51
{
  Node$routingTableCurrentSize[sim_node()] = 0;
  Node$iteration[sim_node()] = 0;
  Node$firstTime[sim_node()] = 1;
  Node$AMControl$start();
  sim_log_debug(169U, "genDebug", "Booted\n");



  Node$randNum[sim_node()] = 5000 + Node$Random$rand16() % 20 * 100;
  Node$seqNO[sim_node()] = 0;
  sim_log_debug(170U, "genDebug", "periodic checker set to %d\n", Node$randNum[sim_node()]);
...
# 11 "dataStructures/modules/HistoryListC.nc"
static void /*NodeC.HistListC*/HistoryListC$0$HistoryList$pushback(pair input)
#line 11
{
...
#line 64
    if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) >= 1) {
        FloodSendP$FloodSend$makePack(&FloodSendP$sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, 
        PROTOCOL_PINGREPLY, __nesc_ntoh_uint16(myMsg->seq.nxdata), (uint8_t *)myMsg->payload, sizeof  myMsg->payload);
...
# 95 "dataStructures/modules/RoutingTableC.nc"
static uint8_t /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$nxtHopFrmDst(uint8_t dest)
#line 95
{
  uint16_t i;
...
# 144 "/home/ubuntu/local/tinyos-2.1.1/tos/lib/timer/VirtualizeTimerC.nc"
static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$startTimer(uint8_t num, uint32_t t0, uint32_t dt, bool isoneshot)
{
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer_t *timer = &/*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$m_timers[sim_node()][num];
...
# 208 "dataStructures/modules/RoutingTableC.nc"
static uint8_t /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$cstFromDst(uint8_t dest)
#line 208
{
  uint16_t i;
...
#line 24
  if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == AM_BROADCAST_ADDR) {
    ...
    if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) >= 1) {
        FloodSendP$FloodSend$makePack(&FloodSendP$sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, 
        PROTOCOL_PING, __nesc_ntoh_uint16(myMsg->seq.nxdata), (uint8_t *)myMsg->payload, sizeof  myMsg->payload);


        temp = FloodSendP$neighborList$nextHopFromDest(__nesc_ntoh_uint16(myMsg->dest.nxdata));
        FloodSendP$Sender$send(FloodSendP$sendPackage[sim_node()], temp);
        sim_log_debug(179U, "Project2DV", "Routing Packet - src: %d, dest: %d, next hop: %d, cost: %d\n", __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), temp, FloodSendP$neighborList$costFromDest(__nesc_ntoh_uint16(myMsg->dest.nxdata)));
      }
    }
}

# 42 "dataStructures/modules/RoutingTableC.nc"
static void /*NodeC.RoutTableC*/RoutingTableC$0$RoutingTable$pushback(dvr element)
#line 42
{
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node$firstTime"))
  {
    *addr = (uintptr_t)&Node$firstTime[__nesc_mote];
    *size = sizeof(Node$firstTime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "Node$routingTableCurrentSize"))
  {
    *addr = (uintptr_t)&Node$routingTableCurrentSize[__nesc_mote];
    *size = sizeof(Node$routingTableCurrentSize[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&Node$firstTime[__nesc_mote], 0, sizeof Node$firstTime[__nesc_mote]);
  memset((void *)&Node$routingTableCurrentSize[__nesc_mote], 0, sizeof Node$routingTableCurrentSize[__nesc_mote]);
